...
const AboutGeneral = () => {
    return (
        <div className="wow fadeIn">
            <h2 className="h1 pt-5 pb-3">INFO</h2>
            ...
            <h2 className="h1 pt-5 pb-3">HOW TO USE</h2>
